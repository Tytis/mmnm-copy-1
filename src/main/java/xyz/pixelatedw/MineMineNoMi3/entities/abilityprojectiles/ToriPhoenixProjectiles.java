  ...
  public static class PhoenixGoen extends AbilityProjectile {
    ...
    public void onUpdate() {
      if (this.worldObj.isRemote) {
        EntityParticleFX particle = (new EntityParticleFX(this.worldObj, ID.PARTICLE_ICON_BLUEFLAME, this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D)).setParticleAge(1).setParticleScale(1.2F);
