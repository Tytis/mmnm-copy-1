...
public class ModelGin extends ModelBiped {
  ...
  public ModelGin() {
    ...
    this.Shape1 = new ModelRenderer((ModelBase)this, 32, 0);
    this.Shape1.addBox(-2.0F, 7.0F, -3.0F, 2, 2, 7);
    this.Shape1.setRotationPoint(-5.0F, 2.0F, 0.0F);
    this.Shape1.setTextureSize(64, 64);
    this.Shape1.mirror = true;
    setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
    this.Shape4 = new ModelRenderer((ModelBase)this, 32, 0);
    this.Shape4.addBox(0.0F, 7.0F, -3.0F, 2, 2, 7);
    this.Shape4.setRotationPoint(5.0F, 2.0F, 0.0F);
    this.Shape4.setTextureSize(64, 64);
    this.Shape4.mirror = true;
    setRotation(this.Shape4, 0.0F, 0.0F, 0.0F);
    this.Shape2 = new ModelRenderer((ModelBase)this, 32, 0);
    this.Shape2.addBox(-2.0F, 2.0F, 4.0F, 2, 8, 2);
    this.Shape2.setRotationPoint(-5.0F, 2.0F, 0.0F);
    this.Shape2.setTextureSize(64, 64);
    this.Shape2.mirror = true;
    setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
    this.Shape3 = new ModelRenderer((ModelBase)this, 32, 0);
    this.Shape3.addBox(-3.0F, -2.0F, 3.0F, 4, 4, 4);
    this.Shape3.setRotationPoint(-5.0F, 2.0F, 0.0F);
    this.Shape3.setTextureSize(64, 64);
    this.Shape3.mirror = true;
    setRotation(this.Shape3, 0.0F, 0.0F, 0.0F);
    this.Shape5 = new ModelRenderer((ModelBase)this, 32, 0);
    this.Shape5.addBox(0.0F, 2.0F, 4.0F, 2, 8, 2);
    this.Shape5.setRotationPoint(5.0F, 2.0F, 0.0F);
    this.Shape5.setTextureSize(64, 64);
    this.Shape5.mirror = true;
    setRotation(this.Shape5, 0.0F, 0.0F, 0.0F);
    this.Shape6 = new ModelRenderer((ModelBase)this, 32, 0);
    this.Shape6.addBox(-1.0F, -2.0F, 3.0F, 4, 4, 4);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    this.Shape3.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.1415927F) * 1.0F * f1;
    this.Shape4.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;
    this.Shape5.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;
    this.Shape6.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;
  }
}
