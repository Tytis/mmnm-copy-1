...
public class ParticleEffectChloroBall extends ParticleEffect {
  public void spawn(EntityPlayer player, double posX, double posY, double posZ) {
    for (int i = 0; i < 256; i++) {
      ...
      MainMod.proxy.spawnCustomParticles((Entity)player, (new EntityParticleFX(player.worldObj, ID.PARTICLE_ICON_DOKU, posX, posY + 1.0D, posZ, motionX, motionY, motionZ))
