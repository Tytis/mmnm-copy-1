...
public class ModelArlong extends ModelBiped {
  ...
  public ModelArlong() {
    ...
    this.Shape1 = new ModelRenderer((ModelBase)this, 33, 0);
    this.Shape1.addBox(0.0F, 0.0F, 0.0F, 1, 4, 6);
    this.Shape1.setRotationPoint(-0.5F, 1.0F, 2.0F);
    this.Shape1.setTextureSize(64, 64);
    this.Shape1.mirror = true;
    setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
    this.Shape2 = new ModelRenderer((ModelBase)this, 0, 33);
    this.Shape2.addBox(0.0F, 0.0F, 0.0F, 2, 1, 5);
    this.Shape2.setRotationPoint(-1.0F, -3.0F, -9.0F);
    this.Shape2.setTextureSize(64, 64);
    this.Shape2.mirror = true;
    setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
    this.Shape3 = new ModelRenderer((ModelBase)this, 0, 0);
    this.Shape3.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
    this.Shape3.setRotationPoint(1.0F, -3.0F, -6.0F);
    this.Shape3.setTextureSize(64, 64);
    this.Shape3.mirror = true;
    setRotation(this.Shape3, 0.0F, 0.0F, 0.0F);
    this.Shape4 = new ModelRenderer((ModelBase)this, 0, 0);
    this.Shape4.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
    this.Shape4.setRotationPoint(1.0F, -3.0F, -8.0F);
    this.Shape4.setTextureSize(64, 64);
    this.Shape4.mirror = true;
    setRotation(this.Shape4, 0.0F, 0.0F, 0.0F);
    this.Shape5 = new ModelRenderer((ModelBase)this, 0, 0);
    this.Shape5.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
    this.Shape5.setRotationPoint(-2.0F, -3.0F, -6.0F);
    this.Shape5.setTextureSize(64, 64);
    this.Shape5.mirror = true;
    setRotation(this.Shape5, 0.0F, 0.0F, 0.0F);
    this.Shape6 = new ModelRenderer((ModelBase)this, 0, 0);
    this.Shape6.addBox(0.0F, 0.0F, 0.0F, 1, 1, 1);
    this.Shape6.setRotationPoint(-2.0F, -3.0F, -8.0F);
    this.Shape6.setTextureSize(64, 64);
    this.Shape6.mirror = true;
    setRotation(this.Shape6, 0.0F, 0.0F, 0.0F);
    this.Shape7 = new ModelRenderer((ModelBase)this, 0, 41);
    this.Shape7.addBox(0.0F, 0.0F, 0.0F, 1, 1, 5);
    this.Shape7.setRotationPoint(-0.5F, -4.0F, -9.0F);
    ...
    this.Shape8.setRotationPoint(-0.5F, -3.5F, -10.0F);
