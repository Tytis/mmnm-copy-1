...
public class BountyLowLevel01 extends Quest implements IKillQuest {
  ...
  public String[] getQuestDescription() {
    return new String[] { "Some low-life pirates are terrorizing the local villagers", "hunt them down fast before they cause more problems !", "", "", "", "", "" };
  }
  ...
  public boolean isTarget(EntityPlayer player, EntityLivingBase target) {
    return target instanceof xyz.pixelatedw.MineMineNoMi3.entities.mobs.pirates.PirateData;
  }
