...
public class ItemCoreArmor extends ItemArmor {
  ...
  public ItemCoreArmor(String name, ItemArmor.ArmorMaterial material, int renderType) {
  ...
  public String getArmorTexture(ItemStack stack, Entity entity, int slot, String layer) {
    return String.format("%s:textures/armor/%s_%d.png", new Object[] { "mineminenomi", this.name, Integer.valueOf((slot == 2) ? 2 : 1) });
  }
