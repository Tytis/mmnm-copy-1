...
public class ModelKrieg extends ModelBiped {
  ...
  public ModelKrieg() {
    ...
    this.Shape1.addBox(-1.0F, 8.0F, -8.0F, 1, 1, 21);
    this.Shape1.setRotationPoint(-5.0F, 2.0F, 0.0F);
    this.Shape1.setTextureSize(64, 64);
    this.Shape1.mirror = true;
    setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
    this.Shape2 = new ModelRenderer((ModelBase)this, 23, 32);
    this.Shape2.addBox(-2.0F, 4.5F, -16.0F, 3, 8, 8);
    this.Shape2.setRotationPoint(-5.0F, 2.0F, 0.0F);
    this.Shape2.setTextureSize(64, 64);
    this.Shape2.mirror = true;
    setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
    this.Shape3 = new ModelRenderer((ModelBase)this, 0, 32);
    this.Shape3.addBox(-1.0F, 6.0F, -19.0F, 1, 5, 5);
