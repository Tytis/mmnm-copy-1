...
public class NikyuAbilities {
  ...
  public static class TsuppariPadHo extends Ability {
    ...
    public void use(EntityPlayer player) {
      this.projectile = (AbilityProjectile)new NikyuProjectiles.PadHo(player.worldObj, (EntityLivingBase)player, this.attr);
      super.use(player);
    }
  }
  ...
  public static class UrsusShock extends Ability {
    ...
    public void endCharging(EntityPlayer player) {
      this.projectile = (AbilityProjectile)new NikyuProjectiles.UrsusShock(player.worldObj, (EntityLivingBase)player, this.attr);
