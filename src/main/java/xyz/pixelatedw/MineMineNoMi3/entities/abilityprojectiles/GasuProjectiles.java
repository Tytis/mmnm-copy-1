  ...
  public static class GasRobe extends AbilityProjectile {
    ...
    public void onUpdate() {
      if (this.worldObj.isRemote) {
        ...
        EntityParticleFX particle = (new EntityParticleFX(this.worldObj, ID.PARTICLE_ICON_GASU, this.posX + posXOffset, this.posY + posYOffset, this.posZ + posZOffset, 0.0D, 0.0D, 0.0D)).setParticleAge(2).setParticleScale(2.0F);
        ...
        particle = (new EntityParticleFX(this.worldObj, ID.PARTICLE_ICON_GASU2, this.posX + posXOffset, this.posY + posYOffset, this.posZ + posZOffset, 0.0D, 0.0D, 0.0D)).setParticleAge(2).setParticleScale(2.0F);
        MainMod.proxy.spawnCustomParticles((Entity)this, particle);
      } 
      super.onUpdate();
    }
