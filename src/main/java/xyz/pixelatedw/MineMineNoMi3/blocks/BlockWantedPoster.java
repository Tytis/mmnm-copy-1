...
public class BlockWantedPoster extends BlockContainer {
  ...
  public AxisAlignedBB getSelectedBoundingBoxFromPool(World world, int x, int y, int z) {
    AxisAlignedBB box = AxisAlignedBB.getBoundingBox(x + 0.9D, y, z, (x + 1), y + 1.25D, (z + 1));
    if (world.getTileEntity(x, y, z) != null) {
      int rot = world.getTileEntity(x, y, z).getBlockMetadata();
      switch (rot) {
        case 2:
          box = AxisAlignedBB.getBoundingBox(x, y, z + 0.9D, (x + 1), y + 1.25D, (z + 1));
          break;
        case 3:
          box = AxisAlignedBB.getBoundingBox(x, y, z, (x + 1), y + 1.25D, z + 0.1D);
          break;
        case 4:
          box = AxisAlignedBB.getBoundingBox(x + 0.9D, y, z, (x + 1), y + 1.25D, (z + 1));
          break;
        case 5:
          box = AxisAlignedBB.getBoundingBox(x, y, z, x + 0.1D, y + 1.25D, (z + 1));
          break;
      } 
    } 
    return box;
  ...
  public void breakBlock(World world, int posX, int posY, int posZ, Block block, int i1) {
    ...
    if (poster.getEntityName().isEmpty() || poster.getPosterBounty().isEmpty() || poster.getIssuedDate().isEmpty())
      return; 
  ...
  public TileEntity createNewTileEntity(World world, int pass) {
    return (TileEntity)new TileEntityWantedPoster();
  }
}
