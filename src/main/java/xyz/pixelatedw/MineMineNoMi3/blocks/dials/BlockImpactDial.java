...
public class BlockImpactDial extends BlockContainer {
  public BlockImpactDial() {
    super(Material.iron);
    setBlockBounds(0.25F, 0.0F, 0.25F, 0.75F, 0.425F, 0.75F);
  }
  ...
  public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
    if (entity instanceof net.minecraft.entity.EntityLivingBase) {
      world.newExplosion(entity, entity.posX, entity.posY, entity.posZ, 3.0F, false, true);
  ...
  public TileEntity createNewTileEntity(World wolrd, int i) {
    return (TileEntity)new TileEntityImpactDial();
  }
}
