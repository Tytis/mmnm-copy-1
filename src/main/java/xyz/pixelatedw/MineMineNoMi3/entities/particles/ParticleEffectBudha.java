...
public class ParticleEffectBudha extends ParticleEffect {
  public void spawn(EntityPlayer player, double posX, double posY, double posZ) {
    ...
    MainMod.proxy.spawnCustomParticles((Entity)player, (new EntityParticleFX(player.worldObj, ID.PARTICLE_ICON_BUDDHA, posX + offsetX, posY + 1.0D, posZ + offsetZ, 0.0D, 0.0D, 0.0D))
    ...
    for (int i = 0; i < 50; i++) {
      ...
      player.worldObj.spawnParticle(EnumParticleTypes.EXPLOSION_LARGE.getParticleName(), posX + offsetX + (new Random())
