...
public class QuestSwordsmanProgression03 extends Quest implements IKillQuest, IProgressionQuest {
  ...
  public boolean isTarget(EntityPlayer player, EntityLivingBase target) {
    ...
    if ((biome.biomeName.equalsIgnoreCase(BiomeGenBase.extremeHills.biomeName) || biome.biomeName.equalsIgnoreCase(BiomeGenBase.extremeHillsPlus.biomeName)) && target instanceof net.minecraft.entity.monster.EntityMob && heldItem != null && (heldItem
      .getItem() instanceof xyz.pixelatedw.MineMineNoMi3.items.weapons.ItemCoreWeapon || heldItem.getItem() instanceof net.minecraft.item.ItemSword))
      return true; 
    return false;
  }
}
