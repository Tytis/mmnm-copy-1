...
public class ItemAbilityWeapon extends ItemCoreWeapon {
  ...
  public void onUpdate(ItemStack itemStack, World world, Entity entity, int par4, boolean par5) {
    if (entity instanceof EntityPlayer) {
      ...
      if (props.getUsedFruit().equals("hiehie") || props.getUsedFruit().equals("pikapika") || props.getUsedFruit().equals("noronoro") || props.getUsedFruit().equals("dorudoru") || props
        .getUsedFruit().equals("gasugasu") || props.getUsedFruit().equals("yukiyuki")) {
