...
public class ModelBisonSpeed extends ModelZoanMorph {
  ...
  public ModelBisonSpeed() {
    ...
    this.lefthorn2.setRotationPoint(2.1F, 6.1F, -5.0F);
    ...
    this.righthorn2.setRotationPoint(-2.1F, 6.1F, -5.0F);
  ...
  public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch, float scaleFactor, Entity ent) {
    ...
    this.rightleg2.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.1415927F) * 0.3F * limbSwingAmount;
    this.rearrightleg1.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 0.4F * limbSwingAmount;
    this.rearleftleg1.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + 3.1415927F) * 0.4F * limbSwingAmount;
  }
