...
public class ModelMr1 extends ModelBiped {
  ...
  public ModelMr1() {
    ...
    this.Shape1.addBox(-4.5F, 0.0F, -0.5F, 2, 10, 1);
    this.Shape1.setRotationPoint(-5.0F, 2.0F, 0.0F);
    this.Shape1.setTextureSize(64, 64);
    this.Shape1.mirror = true;
    setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
    this.Shape2 = new ModelRenderer((ModelBase)this, 33, 0);
    this.Shape2.addBox(2.5F, 0.0F, -0.5F, 2, 10, 1);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    this.Shape2.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;
  }
}
