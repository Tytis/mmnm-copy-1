...
public class ParticleEffectSoru extends ParticleEffect {
  public void spawn(EntityPlayer player, double posX, double posY, double posZ) {
    ...
    MainMod.proxy.spawnCustomParticles((Entity)player, (new EntityParticleFX(player.worldObj, ID.PARTICLE_ICON_SORU, posX + offsetX, posY + 1.0D, posZ + offsetZ, 0.0D, 0.0D, 0.0D))
