...
public class ModelPearl extends ModelBiped {
  ...
  public ModelPearl() {
    ...
    this.Shape1.addBox(-6.0F, 0.0F, -5.0F, 12, 14, 3);
    this.Shape1.setRotationPoint(0.0F, 0.0F, 0.0F);
    this.Shape1.setTextureSize(64, 64);
    this.Shape1.mirror = true;
    setRotation(this.Shape1, 0.0F, 0.0F, 0.0F);
    this.Shape2 = new ModelRenderer((ModelBase)this, 32, 0);
    this.Shape2.addBox(-5.0F, 1.0F, -4.0F, 2, 7, 7);
    this.Shape2.setRotationPoint(-5.0F, 2.0F, 0.0F);
    this.Shape2.setTextureSize(64, 64);
    this.Shape2.mirror = true;
    setRotation(this.Shape2, 0.0F, 0.0F, 0.0F);
    this.Shape3 = new ModelRenderer((ModelBase)this, 32, 0);
    this.Shape3.addBox(3.0F, 1.0F, -4.0F, 2, 7, 7);
    this.Shape3.setRotationPoint(5.0F, 2.0F, 0.0F);
    this.Shape3.setTextureSize(64, 64);
    this.Shape3.mirror = true;
    setRotation(this.Shape3, 0.0F, 0.0F, 0.0F);
    this.Shape4 = new ModelRenderer((ModelBase)this, 30, 32);
    this.Shape4.addBox(-2.0F, 4.0F, -4.0F, 4, 4, 2);
    this.Shape4.setRotationPoint(-2.0F, 12.0F, 0.0F);
    this.Shape4.setTextureSize(64, 64);
    this.Shape4.mirror = true;
    setRotation(this.Shape4, 0.0F, 0.0F, 0.0F);
    this.Shape6 = new ModelRenderer((ModelBase)this, 30, 32);
    this.Shape6.addBox(-2.0F, 4.0F, -4.0F, 4, 4, 2);
    this.Shape6.setRotationPoint(2.0F, 12.0F, 0.0F);
    this.Shape6.setTextureSize(64, 64);
    this.Shape6.mirror = true;
    setRotation(this.Shape6, 0.0F, 0.0F, 0.0F);
    this.Shape5 = new ModelRenderer((ModelBase)this, 30, 38);
    this.Shape5.addBox(-3.0F, -13.0F, -3.0F, 6, 5, 6);
  ...
  public void setRotationAngles(float f, float f1, float f2, float f3, float f4, float f5) {
    ...
    this.Shape3.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;
    this.Shape5.rotateAngleX = MathHelper.cos(f * 0.6662F) * 1.0F * f1;
    this.Shape4.rotateAngleX = MathHelper.cos(f * 0.6662F + 3.1415927F) * 1.0F * f1;
  }
}
