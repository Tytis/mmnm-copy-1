...
public class SniperAbilities {
  ...
  public static class SakuretsuSabotenBoshi extends Ability {
    ...
    public void use(EntityPlayer player) {
      if (!player.worldObj.isRemote) {
        this.projectile = (AbilityProjectile)new SniperProjectiles.SakuretsuSabotenBoshi(player.worldObj, (EntityLivingBase)player, this.attr);
  ...
  public static class RenpatsuNamariBoshi extends Ability {
    ...
    public void use(EntityPlayer player) {
      if (!player.worldObj.isRemote) {
        this.projectile = (AbilityProjectile)new SniperProjectiles.RenpatsuNamariBoshi(player.worldObj, (EntityLivingBase)player, this.attr);
        setPassiveActive(false);
        super.use(player);
      } 
    }
  ...
  public static class KemuriBoshi extends Ability {
    ...
    public void use(EntityPlayer player) {
      if (!player.worldObj.isRemote) {
        this.projectile = (AbilityProjectile)new SniperProjectiles.KemuriBoshi(player.worldObj, (EntityLivingBase)player, this.attr);
        setPassiveActive(false);
        super.use(player);
      } 
    }
  ...
  public static class KaenBoshi extends Ability {
    ...
    public void use(EntityPlayer player) {
      if (!player.worldObj.isRemote) {
        this.projectile = (AbilityProjectile)new SniperProjectiles.KaenBoshi(player.worldObj, (EntityLivingBase)player, this.attr);
        setPassiveActive(false);
        super.use(player);
      } 
    }
