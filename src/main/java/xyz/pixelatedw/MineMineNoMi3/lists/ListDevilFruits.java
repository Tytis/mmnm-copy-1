...
import xyz.pixelatedw.MineMineNoMi3.soros.JishakuJishakuNoMiAbilities;
import xyz.pixelatedw.MineMineNoMi3.soros.JishakuJishakuNoMiProjectiles;
import xyz.pixelatedw.MineMineNoMi3.soros.MochiMochiNoMiAbilities;
import xyz.pixelatedw.MineMineNoMi3.soros.MochiMochiNoMiProjectiles;
import xyz.pixelatedw.MineMineNoMi3.soros.NumaNumaNoMiAbilities;
import xyz.pixelatedw.MineMineNoMi3.soros.NumaNumaNoMiProjectiles;
...
import xyz.pixelatedw.MineMineNoMi3.soros.bisu.Bisu;
import xyz.pixelatedw.MineMineNoMi3.soros.bisu.BisuProjo;
import xyz.pixelatedw.MineMineNoMi3.soros.buddha.BudhaBudha;
import xyz.pixelatedw.MineMineNoMi3.soros.buddha.BudhaBudhaProjo;
import xyz.pixelatedw.MineMineNoMi3.soros.eo.Leopard;
import xyz.pixelatedw.MineMineNoMi3.soros.eo.LeopardProjo;
import xyz.pixelatedw.MineMineNoMi3.soros.mam.Mamouth;
import xyz.pixelatedw.MineMineNoMi3.soros.mam.MamouthProjo;
import xyz.pixelatedw.MineMineNoMi3.soros.nu.Nu;
import xyz.pixelatedw.MineMineNoMi3.soros.nu.NuProjo;
import xyz.pixelatedw.MineMineNoMi3.soros.ptero.Pteranodon;
import xyz.pixelatedw.MineMineNoMi3.soros.ptero.PteranodonProjo;
import xyz.pixelatedw.MineMineNoMi3.soros.soro.SoruSoruNoMi;
import xyz.pixelatedw.MineMineNoMi3.soros.soro.SoruSoruNoMiProjo;

public class ListDevilFruits {
  public static AkumaNoMi MeraMeraNoMi;
  
  public static AkumaNoMi HieHieNoMi;
  
  public static AkumaNoMi BaneBaneNoMi;
  
  public static AkumaNoMi PikaPikaNoMi;
  
  public static AkumaNoMi GomuGomuNoMi;
  
  public static AkumaNoMi SukeSukeNoMi;
  
  public static AkumaNoMi OpeOpeNoMi;
  
  public static AkumaNoMi NoroNoroNoMi;
  
  public static AkumaNoMi GoroGoroNoMi;
  
  public static AkumaNoMi MokuMokuNoMi;
  
  public static AkumaNoMi NikyuNikyuNoMi;
  
  public static AkumaNoMi BomuBomuNoMi;
  
  public static AkumaNoMi GuraGuraNoMi;
  
  public static AkumaNoMi KageKageNoMi;
  
  public static AkumaNoMi SunaSunaNoMi;
  
  public static AkumaNoMi MaguMaguNoMi;
  
  public static AkumaNoMi DoruDoruNoMi;
  
  public static AkumaNoMi DokuDokuNoMi;
  
  public static AkumaNoMi BariBariNoMi;
  
  public static AkumaNoMi GasuGasuNoMi;
  
  public static AkumaNoMi YukiYukiNoMi;
  
  public static AkumaNoMi JuryoJuryoNoMi;
  
  public static AkumaNoMi YamiYamiNoMi;
  
  public static AkumaNoMi ItoItoNoMi;
  
  public static AkumaNoMi HoroHoroNoMi;
  
  public static AkumaNoMi SupaSupaNoMi;
  
  public static AkumaNoMi OriOriNoMi;
  
  public static AkumaNoMi MeroMeroNoMi;
  
  public static AkumaNoMi GoeGoeNoMi;
  
  public static AkumaNoMi KiloKiloNoMi;
  
  public static AkumaNoMi HanaHanaNoMi;
  
  public static AkumaNoMi HoruHoruNoMi;
  
  public static AkumaNoMi BetaBetaNoMi;
  
  public static AkumaNoMi IshiIshiNoMi;
  
  public static AkumaNoMi PamuPamuNoMi;
  
  public static AkumaNoMi UshiUshiNoMiBison;
  
  public static AkumaNoMi ToriToriNoMiPhoenix;
  
  public static AkumaNoMi BakuBakuNoMi;
  
  public static AkumaNoMi YomiYomiNoMi;
  
  public static AkumaNoMi ZouZouNoMi;
  
  public static AkumaNoMi SabiSabiNoMi;
  
  public static AkumaNoMi HitoHitoNoMi;
  
  public static AkumaNoMi ChiyuChiyuNoMi;
  
  public static AkumaNoMi MoguMoguNoMi;
  
  public static AkumaNoMi UshiUshiNoMiGiraffe;
  
  public static AkumaNoMi DoaDoaNoMi;
  
  public static AkumaNoMi KachiKachiNoMi;
  
  public static AkumaNoMi RyuRyuNoMi;
  
  public static AkumaNoMi BudhaBudhaNoMi;
  
  public static AkumaNoMi MochiMochiNoMi;
  
  public static AkumaNoMi JishakuJishakuNoMi;
  
  public static AkumaNoMi NumaNumaNoMi;
  
  public static AkumaNoMi MamouthMamouthNoMi;
  
  public static AkumaNoMi LeopardLeopardNoMi;
  
  public static AkumaNoMi RyuRyuNoMiPteranodon;
  
  public static AkumaNoMi SoruSorunoMi;
  
  public static AkumaNoMi BisuBisuNoMi;
  
  public static AkumaNoMi NuNuNoMi;
  
  private static final Ability[][] EVERY_FRUIT = new Ability[][] { 
      MeraAbilities.abilitiesArray, HieAbilities.abilitiesArray, BaneAbilities.abilitiesArray, PikaAbilities.abilitiesArray, SukeAbilities.abilitiesArray, OpeAbilities.abilitiesArray, GoroAbilities.abilitiesArray, MokuAbilities.abilitiesArray, NikyuAbilities.abilitiesArray, BomuAbilities.abilitiesArray, 
      GuraAbilities.abilitiesArray, KageAbilities.abilitiesArray, SunaAbilities.abilitiesArray, MaguAbilities.abilitiesArray, DoruAbilities.abilitiesArray, DokuAbilities.abilitiesArray, GasuAbilities.abilitiesArray, YukiAbilities.abilitiesArray, ItoAbilities.abilitiesArray, BariAbilities.abilitiesArray, 
      HoroAbilities.abilitiesArray, GoeAbilities.abilitiesArray, NoroAbilities.abilitiesArray, YamiAbilities.abilitiesArray, GomuAbilities.abilitiesArray, UshiBisonAbilities.abilitiesArray, ToriPhoenixAbilities.abilitiesArray, KiloAbilities.abilitiesArray, BakuAbilities.abilitiesArray, JuryoAbilities.abilitiesArray, 
      OriAbilities.abilitiesArray, YomiAbilities.abilitiesArray, ZouAbilities.abilitiesArray, SabiAbilities.abilitiesArray, SupaAbilities.abilitiesArray, MeroAbilities.abilitiesArray, ChiyuAbilities.abilitiesArray, HoruAbilities.abilitiesArray, MoguAbilities.abilitiesArray, DoaAbilities.abilitiesArray, 
      KachiAbilities.abilitiesArray, MiniAbilities.abilitiesArray, UshiGiraffeAbilities.abilitiesArray, MochiMochiNoMiAbilities.abilitiesArray, JishakuJishakuNoMiAbilities.abilitiesArray, NumaNumaNoMiAbilities.abilitiesArray, RyuRyuNoMiAbilities.abilitiesArray, Mamouth.abilitiesArray, Leopard.abilitiesArray, BudhaBudha.abilitiesArray, 
      Pteranodon.abilitiesArray, SoruSoruNoMi.abilitiesArray, Bisu.abilitiesArray, Nu.abilitiesArray, RokushikiAbilities.abilitiesArray, FishKarateAbilities.abilitiesArray, CyborgAbilities.abilitiesArray, SniperAbilities.abilitiesArray, SwordsmanAbilities.abilitiesArray, DoctorAbilities.abilitiesArray, 
      WeatherAbilities.abilitiesArray, HakiAbilities.abilitiesArray };
  
  public static final Object[] ALL_ENTITIES = new Object[] { 
      RokushikiProjectiles.abilitiesClassesArray, MeraProjectiles.abilitiesClassesArray, HieProjectiles.abilitiesClassesArray, BaneProjectiles.abilitiesClassesArray, PikaProjectiles.abilitiesClassesArray, NoroProjectiles.abilitiesClassesArray, SukeProjectiles.abilitiesClassesArray, OpeProjectiles.abilitiesClassesArray, GoroProjectiles.abilitiesClassesArray, MokuProjectiles.abilitiesClassesArray, 
      NikyuProjectiles.abilitiesClassesArray, BomuProjectiles.abilitiesClassesArray, GuraProjectiles.abilitiesClassesArray, KageProjectiles.abilitiesClassesArray, SunaProjectiles.abilitiesClassesArray, MaguProjectiles.abilitiesClassesArray, DoruProjectiles.abilitiesClassesArray, DokuProjectiles.abilitiesClassesArray, GasuProjectiles.abilitiesClassesArray, YukiProjectiles.abilitiesClassesArray, 
      ItoProjectiles.abilitiesClassesArray, FishKarateProjectiles.abilitiesClassesArray, CyborgProjectiles.abilitiesClassesArray, ExtraProjectiles.abilitiesClassesArray, BariProjectiles.abilitiesClassesArray, HoroProjectiles.abilitiesClassesArray, GoeProjectiles.abilitiesClassesArray, NoroProjectiles.abilitiesClassesArray, YamiProjectiles.abilitiesClassesArray, GomuProjectiles.abilitiesClassesArray, 
      SwordsmanProjectiles.abilitiesClassesArray, ToriPhoenixProjectiles.abilitiesClassesArray, SniperProjectiles.abilitiesClassesArray, JuryoProjectiles.abilitiesClassesArray, BakuProjectiles.abilitiesClassesArray, ZouProjectiles.abilitiesClassesArray, SupaProjectiles.abilitiesClassesArray, MeroProjectiles.abilitiesClassesArray, OriProjectiles.abilitiesClassesArray, UshiGiraffeProjectiles.abilitiesClassesArray, 
      WeatherProjectiles.abilitiesClassesArray, MochiMochiNoMiProjectiles.abilitiesClassesArray, JishakuJishakuNoMiProjectiles.abilitiesClassesArray, NuProjo.abilitiesClassesArray, NumaNumaNoMiProjectiles.abilitiesClassesArray, RyuRyuNoMiProjectiles.abilitiesClassesArray, PteranodonProjo.abilitiesClassesArray, BudhaBudhaProjo.abilitiesClassesArray, MamouthProjo.abilitiesClassesArray, LeopardProjo.abilitiesClassesArray, 
      SoruSoruNoMiProjo.abilitiesClassesArray, BisuProjo.abilitiesClassesArray };
  ...
  public static void init() {
    ...
    HitoHitoNoMi = new AkumaNoMi(EnumFruitType.ZOAN, new Ability[0]);
    ...
    MochiMochiNoMi = new AkumaNoMi(EnumFruitType.LOGIA, MochiMochiNoMiAbilities.abilitiesArray);
    addITEM(MochiMochiNoMi, "Mochi Mochi no Mi");
    JishakuJishakuNoMi = new AkumaNoMi(EnumFruitType.PARAMECIA, JishakuJishakuNoMiAbilities.abilitiesArray);
    addITEM(JishakuJishakuNoMi, "Jishaku Jishaku No Mi");
    NumaNumaNoMi = new AkumaNoMi(EnumFruitType.LOGIA, NumaNumaNoMiAbilities.abilitiesArray);
    addITEM(NumaNumaNoMi, "Numa Numa No Mi");
    RyuRyuNoMi = new AkumaNoMi(EnumFruitType.MYTHICALZOAN, RyuRyuNoMiAbilities.abilitiesArray);
    addITEM(RyuRyuNoMi, "Ryu Ryu no Mi");
    BudhaBudhaNoMi = new AkumaNoMi(EnumFruitType.MYTHICALZOAN, BudhaBudha.abilitiesArray);
    addITEM(BudhaBudhaNoMi, "Budha Budha no Mi");
    MamouthMamouthNoMi = new AkumaNoMi(EnumFruitType.ANCIENTZOAN, Mamouth.abilitiesArray);
    addITEM(MamouthMamouthNoMi, "Mamouth Mamouth no Mi");
    LeopardLeopardNoMi = new AkumaNoMi(EnumFruitType.ZOAN, Leopard.abilitiesArray);
    addITEM(LeopardLeopardNoMi, "Leopard Leopard no Mi");
    RyuRyuNoMiPteranodon = new AkumaNoMi(EnumFruitType.ANCIENTZOAN, Pteranodon.abilitiesArray);
    addITEM(RyuRyuNoMiPteranodon, "Pteranodon Ryu Ryu no Mi");
    SoruSorunoMi = new AkumaNoMi(EnumFruitType.PARAMECIA, SoruSoruNoMi.abilitiesArray);
    addITEM(SoruSorunoMi, "Soru Soru No Mi");
    BisuBisuNoMi = new AkumaNoMi(EnumFruitType.PARAMECIA, Bisu.abilitiesArray);
    addITEM(BisuBisuNoMi, "Bisu Bisu No Mi");
    NuNuNoMi = new AkumaNoMi(EnumFruitType.MYTHICALZOAN, Nu.abilitiesArray);
    addITEM(NuNuNoMi, "Nu Nu No Mi");
  ...
  public static void addITEM(AkumaNoMi item, String localizedName) {
    ...
    WyRegistry.registerItem((Item)item, localizedName, ListCreativeTabs.tabDevilFruits);
  }
}
