...
public class ParticleEffectCommonExplosion extends ParticleEffect {
  public void spawn(EntityPlayer player, double posX, double posY, double posZ) {
    ...
    for (int i = 0; i < 256; i++) {
      ...
      player.worldObj.spawnParticle("explode", posX, posY + 1.0D, posZ, motionX, motionY, motionZ);
      player.worldObj.spawnParticle("smoke", posX, posY + 1.0D, posZ, motionX, motionY, motionZ);
    } 
  }
}
