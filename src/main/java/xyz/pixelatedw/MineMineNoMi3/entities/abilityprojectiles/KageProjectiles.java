...
public class KageProjectiles {
  ...
  public static class BlackBox extends AbilityProjectile {
    ...
    public void tasksImapct(MovingObjectPosition hit) {
      if (hit.entityHit != null)
        WyHelper.createFilledCube(hit.entityHit, new int[] { 2, 2, 2 }, ListMisc.KageBlock, new String[] { "air" }); 
    }
  }
  ...
  public static class TsunotokagePillar extends AbilityProjectile {
    ...
    public void onEntityUpdate() {
      for (EntityLivingBase e : WyHelper.getEntitiesNear((Entity)this, 2.0D))
        e.attackEntityFrom(DamageSource.causePlayerDamage((EntityPlayer)getThrower()), 90.0F); 
