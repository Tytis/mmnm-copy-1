...
public class HoroAbilities {
  ...
  public static class TokuHollow extends Ability {
    ...
    public void use(EntityPlayer player) {
      this.projectile = (AbilityProjectile)new HoroProjectiles.TokuHollow(player.worldObj, (EntityLivingBase)player, this.attr);
      super.use(player);
    }
  }
  ...
  public static class MiniHollow extends Ability {
    ...
    public void use(EntityPlayer player) {
      this.projectile = (AbilityProjectile)new HoroProjectiles.MiniHollow(player.worldObj, (EntityLivingBase)player, this.attr);
      super.use(player);
    }
  }
  ...
  public static class NegativeHollow extends Ability {
    ...
    public void use(EntityPlayer player) {
      this.projectile = (AbilityProjectile)new HoroProjectiles.NegativeHollow(player.worldObj, (EntityLivingBase)player, this.attr);
      super.use(player);
    }
  }
}
