...
public class ExtraProjectiles {
  ...
  public static class MilkyDialProjectile extends AbilityProjectile {
    ...
    public void onUpdate() {
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX, (int)this.posY - 1, (int)this.posZ, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX + 1, (int)this.posY - 1, (int)this.posZ, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX - 1, (int)this.posY - 1, (int)this.posZ, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX + 1, (int)this.posY - 1, (int)this.posZ + 1, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX + 1, (int)this.posY - 1, (int)this.posZ - 1, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX - 1, (int)this.posY - 1, (int)this.posZ + 1, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX, (int)this.posY - 1, (int)this.posZ + 1, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX, (int)this.posY - 1, (int)this.posZ - 1, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX - 1, (int)this.posY - 1, (int)this.posZ - 1, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      DevilFruitsHelper.placeBlockIfAllowed(this.worldObj, (int)this.posX, (int)this.posY - 2, (int)this.posZ, ListMisc.SkyBlock, 1, 3, new String[] { "air" });
      super.onUpdate();
    }
  }
  ...
  public static class AxeDialProjectile extends AbilityProjectile {
    ...
    public void tasksImapct(MovingObjectPosition hit) {
      WyHelper.doExplosion((Entity)getThrower(), this.posX, this.posY, this.posZ, 4.0D);
    }
  }
