  ...
  public static class CoupDeVent extends AbilityProjectile {
    ...
    public void tasksImapct(MovingObjectPosition hit) {
      if (hit.entityHit != null) {
        ...
        hit.entityHit.motionY += 2.0D;
        WyHelper.Direction dir = WyHelper.get4Directions(hit.entityHit);
  ...
  public static class FreshFire extends AbilityProjectile {
    ...
    public void onUpdate() {
      if (this.worldObj.isRemote) {
        EntityParticleFX particle = new EntityParticleFX(this.worldObj, ID.PARTICLE_ICON_MERA, this.posX, this.posY + 0.5D, this.posZ, 0.0D, 0.0D, 0.0D);
