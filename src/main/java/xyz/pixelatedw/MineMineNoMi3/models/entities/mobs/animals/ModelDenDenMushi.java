...
public class ModelDenDenMushi extends ModelBiped {
  ...
  public ModelDenDenMushi() {
    ...
    this.Shape2 = new ModelRenderer((ModelBase)this, 21, 11);
    ...
    this.Shape7 = new ModelRenderer((ModelBase)this, 34, 3);
